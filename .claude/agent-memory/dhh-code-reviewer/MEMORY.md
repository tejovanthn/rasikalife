...
- [ElectroDB key casing bug](electrodb-key-casing-bug.md) — ElectroDB writes lowercase pk/sk; every hand-built UPPERCASE Key in cascade.ts silently matches nothing
