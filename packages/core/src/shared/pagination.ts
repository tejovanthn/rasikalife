 ...
 */
export const normalizePaginationParams = (params?: Partial<PaginationParams>): PaginationParams => {
 ...
 */
export const createNextToken = (lastEvaluatedKey?: Record<string, any>): string | undefined => {
  if (!lastEvaluatedKey) {
    return undefined;
  }
 ...
 */
export const parseNextToken = (nextToken?: string): Record<string, any> | undefined => {
  if (!nextToken) {
    return undefined;
  }
