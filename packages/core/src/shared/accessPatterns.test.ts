...
describe('Access Patterns', () => {
  ...
  describe('getByGlobalIndex', () => {
    ...
    it('should get items by GSI1 with sort key', async () => {
      const result = await getByGlobalIndex('GSI1', 'GSI1PK', 'STATUS#scheduled', {
        sortKeyName: 'GSI1SK',
  ...
  describe('getByStatusAndDateRange', () => {
    it('should get items by status and date range', async () => {
      const result = await getByStatusAndDateRange('GSI1', 'STATUS', 'scheduled', 'DATE', {
        start: '2023-01-01',
        end: '2023-01-31',
      });
  ...
  describe('getByDateRange', () => {
    it('should get items by date range in sort key', async () => {
      const result = await getByDateRange(EntityPrefix.USER, '1', 'KARMA', {
        start: '2023-01-01',
        end: '2023-01-31',
      });
